...
os.system('espeak -a 300 " Update, Version, 6.4"')
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mUpdate Version 6.4😎...? ')
os.system('espeak -a 300 " Tools, Is, Paid, Free, User, Not, Allow"')
os.system('espeak -a 300 " AKASH, Boss, Is, Always, King, Ok, Bro..."')
time.sleep(5)
os.system('clear')
os.system('espeak -a 600 " Join, My, Messenger, Group"')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN MY MASSENGER GROUP")
time.sleep(2)
os.system(f'xdg-open https://m.me/j/AbbhMnwMawg4zuOY/')
#------------------[ AKASH ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
def menu():
    ...
    if AKASH in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801778809977')
        os.system("python nono.py")
    elif AKASH in ['3','03']:
        result()
    elif AKASH in ['0']:
...
def setting():
    ...
    print('\033[0;91m==================')
    print('\033[0;91m==================')
    print("\033[97;1m[\033[92;1m1\033[97;1m] METHOD 1 [\033[0;92mCp Show \033[0;91mOm ID Not Show\033[1;37m]")
    print("\033[97;1m[\033[92;1m2\033[97;1m] METHOD 2 [\033[0;93mOk id Show\033[1;37mShow Only Ok Id \033[1;37m]")
    print('\033[0;91m==================')
